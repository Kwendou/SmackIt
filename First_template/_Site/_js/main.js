...
//Nav
    ...
    $( ".nav__el--home" ).click(function()
    {
        ...
        $(".challenge_easy").removeClass("challenge__active");
        $(".challenge_hard").removeClass("challenge__active");
        $(".challenge_yolo").removeClass("challenge__active");
        $(".profil").removeClass("profil__active");
        $(".boules").removeClass("boules__active");
        $(".selfieMondiaux").removeClass("selfieMondiaux__active");
     });
    ...
    $(".nav__el--players").click(function()
    {
        ...
        $(".profil").removeClass("profil__active");
        $(".boules").removeClass("boules__active");
        $(".selfieMondiaux").addClass("selfieMondiaux__active");
    });
    ...
    $(".nav__el--profil").click(function()
    {
        ...
        $(".challenge_hard").removeClass("challenge__active");
        $(".challenge_yolo").removeClass("challenge__active");
        $(".profil").addClass("profil__active");
        $(".boules").addClass("boules__active");
        $(".selfieMondiaux").removeClass("selfieMondiaux__active");
    ...
    $(".easy").click(function()
    {
        $(".challenge_easy").addClass("challenge__active");
        $(".btn__home").removeClass("btn__home--active");
    });
    
    $ (".hard").click(function()
    {
        $(".challenge_hard").addClass("challenge__active");
        $(".btn__home").removeClass("btn__home--active");
    });
    
    $ (".yolo").click(function()
    {
        $(".challenge_yolo").addClass("challenge__active");
        $(".btn__home").removeClass("btn__home--active");
    });
...
$(".challenge__button").click(function()
{
    
    $(".quote_easy").each(function()
        {
                //var random = Math.floor(Math.random() * $(this).find("span").length);
                $(this).find("span:eq("+ monRandom() +")").css("display","inline");
        });
        ...
        var quotes = new Array("<p>Ton père est un voleur, il a pris toutes les étoiles du ciel, pour les mettre dans tes yeux. </p>",
                               ...
                               "<p>Ton père est bijoutier ? <p>Non pourquoi ?</p> <p>Parce que tu es une fille en Or.</p>", 
        ...
        $('.quote_easy').append(quotes[randno]);
        ...
        $ ( '.quote_easy' ). css ({ 
            ...
            'left' : '50%' ,
            'margin-left' : '-160px' ,
            'margin-top'  :  - $ ( ".quote_easy" ). height ()/ 2
        });
...
//Aleatoire Hard
      ...
      $(".quote_hard").each(function(){
         $(this).find("span:eq("+Math.floor(Math.random()*jQuery(this).find("span").length)+")").css("display","inline");
      });
    ...
    var randno = Math.floor(Math.random()*(quotes.length));
    $('.quote_hard').append(quotes[randno]);
    ...
    $ ( '.quote_hard' ). css ({ 
        ...
        'left' : '50%' ,
        'margin-left' : '-160px' ,
        'margin-top'  :  - $ ( ".quote_hard" ). height ()/ 2
    });
...
//Aleatoire Yolo
    ...
    var quotes = new Array("<p>Ton père est un voleur, il a pris toutes les étoiles du ciel, pour les mettre dans tes yeux. </p>",
                           ...
                           "<p>Tu savais que tu as 206 os à l’intérieur de ton corps ? Ça te dirait d’en avoir un de plus ?</p>");
    var randno = Math.floor(Math.random()*(quotes.length));
    $('.quote_yolo').append(quotes[randno]);
    ...
    $ ( '.quote_yolo' ). css ({ 
        ...
        'left' : '50%' ,
        'margin-left' : '-160px' ,
        'margin-top'  :  - $ ( ".quote_yolo" ). height ()/ 2
    });
...
$(".ball__un").click(function(){
    $(".plein").addClass("plein__deuxToun");
    $(".plein").removeClass("plein__unTodeux");

    if ($(".plein").hasClass("plein__troisTodeux")) {
        $(".plein").removeClass("plein__troisTodeux");
    };
    ...
    if ($(".lost").hasClass("show")) {
        $(".lost").removeClass("show");
        $(".lost").addClass("hide");
    };

    if ($(".ideas").hasClass("show")) {
        $(".ideas").removeClass("show");
        $(".ideas").addClass("hide");
    };
});

$(".ball__deux").click(function(){
    $(".win").addClass("show");

    $(".plein").addClass("plein__unTodeux");
    $(".plein").removeClass("plein__deuxToun");

    if ($(".plein").hasClass("plein__quatreTotrois")) {
        $(".plein").removeClass("plein__quatreTotrois");
        $(".plein").removeClass("plein__unTodeux");
        $(".plein").addClass("plein__troisTodeux");

    };

    if ($(".plein").hasClass("plein__deuxTotrois")) {
        $(".plein").removeClass("plein__deuxTotrois");
        $(".plein").removeClass("plein__unTodeux");
        $(".plein").addClass("plein__troisTodeux");
    };
...
$(".ball__trois").click(function(){
    $(".lost").addClass("show");
    $(".plein").addClass("plein__deuxTotrois");
    $(".plein").removeClass("plein__troisTodeux");
    $(".plein").removeClass("plein__unTodeux");

    if ($(".plein").hasClass("plein__troisToquatre")) {
        $(".plein").removeClass("plein__troisToquatre");
        $(".plein").removeClass("plein__deuxTotrois");
        $(".plein").addClass("plein__quatreTotrois");
    };

    if ($(".lost").hasClass("hide")) {
...
$(".ball__quatre").click(function(){

    $(".plein").removeClass("plein__deuxTotrois");
    $(".plein").addClass("plein__troisToquatre");

    $(".ideas").addClass("show");

    if ($(".ideas").hasClass("hide")) {
        $(".ideas").removeClass("hide");
        $(".ideas").addClass("show");
    };
});
